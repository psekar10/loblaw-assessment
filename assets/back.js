...
export default function Back({height, width}) {
	return (
		<svg version="1.1" id="Capa_1" height={height} width={width} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
			viewBox="0 0 512 512" enableBackground="new 0 0 512 512" xmlSpace="preserve">
			<path fill="#4DBBEB" d="M493.52,211.306c-11.938-11.936-27.807-18.509-44.728-18.509l-233.002-0.003l28.465-28.464
			...
			<path fill="#2488FF" d="M18.584,300.76l136.288,136.287c11.939,11.958,27.822,18.543,44.723,18.543
